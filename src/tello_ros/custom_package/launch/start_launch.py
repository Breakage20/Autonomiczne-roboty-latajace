...
def generate_launch_description():
    ns = 'drone1'
    world_path = os.path.join(get_package_share_directory('tello_custom'), 'worlds', 'fiducial.world')
    urdf_path = os.path.join(get_package_share_directory('tello_description'), 'urdf', 'tello_1.urdf')
    rviz_config = os.path.join(get_package_share_directory('tello_custom'), 'rviz', 'rviz.rviz')
